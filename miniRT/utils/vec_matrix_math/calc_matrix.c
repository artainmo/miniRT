...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/01/19 09:45:25 by artainmo          #+#    #+#             */
/*   Updated: 2020/01/19 10:02:31 by artainmo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_mat	ft_fill_4x4matrix(t_vec x_ax, t_vec y_ax, t_vec z_ax, t_vec c)
{
	t_mat cam_to_world_matrix;

	cam_to_world_matrix.r0.x = x_ax.x;
	cam_to_world_matrix.r0.y = x_ax.y;
	cam_to_world_matrix.r0.z = x_ax.z;
	cam_to_world_matrix.r1.x = y_ax.x;
	cam_to_world_matrix.r1.y = y_ax.y;
	cam_to_world_matrix.r1.z = y_ax.z;
	cam_to_world_matrix.r2.x = z_ax.x;
	cam_to_world_matrix.r2.y = z_ax.y;
	cam_to_world_matrix.r2.z = z_ax.z;
	cam_to_world_matrix.r3.x = c.x;
	cam_to_world_matrix.r3.y = c.y;
	cam_to_world_matrix.r3.z = c.z;
...
t_vec	ft_cam_world_matrix(t_vec norm_scr, t_vec camera_norm_dir, t_vec ca_p)
{
	t_vec z_axis;
	t_vec x_axis;
	t_vec y_axis;
	...
	return (ft_matrix_transform(norm_scr, cam_world_matrix));
}
