...
/*   Updated: 2020/01/19 10:10:48 by artainmo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_col			ft_cum_light_ch(t_s *s, t_inter *i, t_s *s_l, t_col cum);
t_inter			*ft_set_new_closest_intersection(t_ray ray, t_inter *inter);
t_inter			*ft_inter_color(t_s *s, t_inter *i, t_light l, t_col o);
t_inter			*ft_shadows(t_s *s, t_inter *inter, t_light l);
t_inter			*ft_sphere_intersection(t_s *s, t_inter *i, t_ray ray
		, t_light l);
t_inter			*ft_plane_intersection(t_s *s, t_inter *i, t_ray ray
		, t_light l);
t_inter			*ft_square_inter(t_s *s, t_inter *i, t_ray ray, t_light l);
t_inter			*ft_triangle_intersection(t_s *s, t_inter *i, t_ray ra
		, t_light l);
int				ft_inter_in_tr(t_vec p1, t_vec p2, t_vec p3, t_vec p);
t_inter			*ft_cylinder_inter(t_s *s, t_inter *i, t_ray ra, t_light l);
...
int				triangle_intersection_boolean(t_s *s, t_ray ray
		, t_inter *inter);
int				cylinder_intersection_boolean(t_s *s, t_ray ray
		, t_inter *inter);
